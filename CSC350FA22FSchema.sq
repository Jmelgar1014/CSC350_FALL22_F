...
--
-- Table structure for table `laundrydata`
--

DROP TABLE IF EXISTS `laundrydata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `laundrydata` (
...
CREATE TABLE `weekschedule` (
  ...
  `nameofday` varchar(15) DEFAULT NULL,
  `timeinterval` varchar(30) DEFAULT NULL,
...
/*!50003 DROP PROCEDURE IF EXISTS `InsertDate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertDate`(dt datetime)
BEGIN
   ...
   VALUES(
		Date_Format(dt, "%W"),
        concat(DATE_FORMAT(dt, "%r"), ' - ',DATE_FORMAT(date_add(dt, interval 2 hour), "%r")),
        dt,
        0);
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LoadDate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `LoadDate`()
BEGIN
DECLARE counter INT DEFAULT 1;
DECLARE dateCurrent datetime;
DECLARE dateCurrentDayInWeek tinyint;
Declare dateLastMonday datetime;
Declare dt datetime;
...
set dt = dateLastMonday ;

WHILE counter <= 84 DO
CALL InsertDate(dt);
SET dt = DATE_ADD(dt, INTERVAL 2 hour);
...
-- Dump completed on 2022-12-21 18:28:53
